...
class AttackItem extends Item {
  ...
  /// Factory constructor richiesto dalla traccia:
  /// consente di creare rapidamente un oggetto predefinito.
  factory AttackItem.choiceBand() {
    return AttackItem('Choice Band', 12);
  }

  /// Secondo factory constructor per avere più varietà di oggetti offensivi.
  factory AttackItem.lifeOrb() {
...
class SpecialItem extends Item {
  ...
  factory SpecialItem.twistedSpoon() {
    return SpecialItem('Twisted Spoon', 10);
  }

  factory SpecialItem.wiseGlasses() {
...
class DefensiveItem extends Item {
  ...
  factory DefensiveItem.rockyHelmet() {
    return DefensiveItem('Rocky Helmet', 11);
  }

  factory DefensiveItem.eviolite() {
...
class UtilityItem extends Item {
  ...
  factory UtilityItem.quickClaw() {
    return UtilityItem('Quick Claw', 6);
  }

  factory UtilityItem.choiceScarf() {
...
class RemoteItemLoader extends ItemLoader {
  ...
  Future<Item> load(String id) async {
    ...
    switch (id) {
      case 'attack_1':
        return AttackItem.choiceBand();

      case 'attack_2':
        return AttackItem.lifeOrb();

      case 'special_1':
        return SpecialItem.twistedSpoon();

      case 'special_2':
        return SpecialItem.wiseGlasses();

      case 'defense_1':
        return DefensiveItem.rockyHelmet();

      case 'defense_2':
        return DefensiveItem.eviolite();

      case 'utility_1':
        return UtilityItem.quickClaw();

      case 'utility_2':
        return UtilityItem.choiceScarf();
